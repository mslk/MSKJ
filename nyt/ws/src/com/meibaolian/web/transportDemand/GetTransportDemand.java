 ...
 *  
 */
public class GetTransportDemand extends BaseServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Logger logger = Logger.getLogger(GetTransportDemand.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			qr = transportDemandService.searchTransportDemand(userid, page, pageSize, orders);
