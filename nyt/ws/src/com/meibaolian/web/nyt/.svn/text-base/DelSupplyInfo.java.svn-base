 ...
 *  
 */
public class DelSupplyInfo extends BaseServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Logger logger = Logger.getLogger(DelSupplyInfo.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		int count=0;
		try{
			count = vennerInfoService.delSupplyInfo(userid,id);
			if(count > 0){
