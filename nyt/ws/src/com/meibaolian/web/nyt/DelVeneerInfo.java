 ...
 *  
 */
public class DelVeneerInfo extends BaseServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Logger logger = Logger.getLogger(DelVeneerInfo.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		int count=0;
		try{
			count = vennerInfoService.delVennerInfo(userid,id);
			if(count > 0){
