 ...
 *
 */
public class UpdateNytMyPurchase extends BaseServlet {
	...
	Logger logger=Logger.getLogger(UpdateNytMyPurchase.class); 
	...
	protected void doPost(HttpServletRequest request,
		...
		{
			try {
				if(purchaseInfoService.update(purchaseInfo)==1)
				{
