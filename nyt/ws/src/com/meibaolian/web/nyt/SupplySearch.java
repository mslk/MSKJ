...
public class SupplySearch extends BaseServlet {
	...
	public void setSupplyService(ISupplyService supplyService) {
		this.supplyService = supplyService;
	}

	Logger logger = Logger.getLogger(SupplySearch.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		QueryResult<SupplyInfoExpand> list = null;
		try {
			list = supplyService.search(page, pageSize, dto);
