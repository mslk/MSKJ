package com.meibaolian.dao.providerpush.impl;
...
public class ProviderpushDao extends BaseDao<Providerpush> implements IProviderpushDao{

	@Override
	public int addProviderpush(SearchlogCoal searchlog, int status){
		/**
		 * insert into providerpush (userid,addtime,coaltype,coalnameminheatingtype,
		 ...
		 */
		String tableName = TableRules.getProviderpushRule();
