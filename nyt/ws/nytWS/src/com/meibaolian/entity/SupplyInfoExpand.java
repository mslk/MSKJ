...
public class SupplyInfoExpand implements java.io.Serializable {
	...
	/** default constructor */
	public SupplyInfoExpand() {
	}

	/** minimal constructor */
	public SupplyInfoExpand(Integer userid, Integer number, Integer price,
	...
	/** full constructor */
	public SupplyInfoExpand(Integer id, Integer userid, String length,
			...
			String producer, Integer type, String addtime, String phone,
			String realname, String companyname, String place_receipt,
			String province, String city, String county, String park,
			String logo) {
		super();
		this.id = id;
		this.userid = userid;
