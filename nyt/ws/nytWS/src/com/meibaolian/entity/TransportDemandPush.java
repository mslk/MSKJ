...
/**
 * Transportdemandpush entity. @author MyEclipse Persistence Tools
 */

public class TransportDemandPush implements java.io.Serializable {
	...
	/** default constructor */
	public TransportDemandPush() {
	}

	/** minimal constructor */
	public TransportDemandPush(Integer status) {
		this.status = status;
	}

	/** full constructor */
	public TransportDemandPush(Integer userid, String username, String phone,
			Timestamp addtime, String start, String stop, Double price,
			Integer quantity, Timestamp validdate, Integer status) {
		this.userid = userid;
