				...
				<td colspan="2" class="thead">
						<c:choose>
					    	...
					    	<c:when test="${dto.int_valueA ==2 }">
					    		 <div class="tit_box">胶合板求购详情</div>
					    	</c:when>
					    	<c:when test="${dto.int_valueA ==3 }">
					    		 <div class="tit_box">原木求购详情</div>
					    	</c:when>
					    	<c:when test="${dto.int_valueA ==4 }">
					    		 <div class="tit_box">淀粉求购详情</div>
					    	</c:when>
					    </c:choose>
				</td>
			</tr>
			...
			<tr>
			 ...
			 <tr>
	    		<td colspan="2"  style="text-align: center;">
					<input type="button" value="返回"  onclick="javascript:location.href='nyt/woodPurchasesearch.action?dto.int_valueA=${dto.int_valueA}'" />
			 	</td>
			 </tr>
		</table>
	</body>
