...
<html>
	...
	<body>
		<form  id="form1" action="transportDemand/updateSortnumber.action" method="post">
		<table class="publictable" border="0" cellspacing="1" cellpadding="0">
			<input type="hidden" name="transportDemand.id" value="${transportDemand.id}" />
			<tr>
			...
			<tr>
				...
				<td width="70%">
					<input type="text" name="transportDemand.sortnumber" value="${transportDemand.sortnumber }"/>
