...
public class TransportDemand  implements java.io.Serializable {
	...
	/** minimal constructor */
    public TransportDemand(Integer userid, Timestamp addtime) {
        this.userid = userid;
        this.addtime = addtime;
    }
    
    /** full constructor */
    public TransportDemand(Integer userid, String username, String phone, Timestamp addtime, String start, String stop, Double price, Integer quantity, Timestamp sendoutdate, Timestamp validdate, Integer sortnumber, Integer status, Integer startid, Integer startcityid, String startcityname, Integer startprvid, String startprvname, Integer stopid, Integer stopcityid, String stopcityname, Integer stopprvid, String stopprvname, String startshortname, String stopshortname) {
        this.userid = userid;
    ...
    public Timestamp getSendoutdate() {
        return this.sendoutdate;
    }
    
    public void setSendoutdate(Timestamp sendoutdate) {
        this.sendoutdate = sendoutdate;
    }
