...
<html>
	...
	<body>
	  <form id="form1" action="otherAid/updateQualityControl.action" method="post">
	  	<input type="hidden" name="qualityControl.id" value="${qualityControl.id}" />
		<table class="publictable" border="0" cellspacing="1" cellpadding="0">
			...
			<tr>
				...
				<td width="30%">
					<input type="text" id="number" name="qualityControl.number" value="${qualityControl.number }" />
				</td>
			...
			<tr>
				...
				<td width="30%">
					<input type="text" name="qualityControl.quanshuifen" value="${qualityControl.quanshuifen }" />
				</td>
				<td width="40%"></td>
			</tr> 
			<tr>
				...
				<td width="30%">
				    <input type="text" name="qualityControl.shuifen" 	value="${qualityControl.shuifen }" />
