...
<html>
	...
	<body>
		<form  id="form1" action="purchase/updateSortnumber.action" method="post">
		<table class="publictable" border="0" cellspacing="1" cellpadding="0">
			<input type="hidden" name="purchase.purid" value="${purchase.purid}" />
			<tr>
			...
			<tr>
				...
				<td width="70%">
					<input type="text" name="purchase.sortnumber" value="${purchase.sortnumber }"/>
